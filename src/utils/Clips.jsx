...
const Clips = ({ clip, imgsrc }) => {
	return (
		<>
			<div className=' relative h-28 w-28 rounded-xl overflow-hidden cursor-pointer transition-all duration-300 group lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14  '>
				<img
