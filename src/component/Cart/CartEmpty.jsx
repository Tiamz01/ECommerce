	...
	return (
		<div>
			<div className='flex items-center justify-center  flex-col gap-7 h-screen px-11 text-center'>
				...
				/>
				<button className='button-theme bg-gradient-to-b from-amber-500 to-orange-500 flex items-center gap-4 justify-center shadow-lg shadow-orange-500 py-2 text-slate-800 active:scale-110'>
