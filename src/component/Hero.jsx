				...
				<div className='relative opacity-100 z-20 grid justify-items-center items-center nike-container'>
					...
					<div className='flex items-center justify-center'>
						<LazyLoadImage
							...
							effect="blur"
							src={img}
							className='w-auto h-[45vh] lg:h-[35vh] md:h-[28vh] sm:h-[21vh] xsm:h-[17vh] sm:w-[18rem] xsm:w-[14rem] transitions-theme-slow -rotate-[25deg] hover:rotate-0 object-fill cursor-pointer mt-8 sm:mt-4 transition-transform duration-1000 ease-in-out'
							threshold={100}
							placeholderSrc={img}
						/>
					</div>
